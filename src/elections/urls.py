...
@router.get(
    "",
    description="Return a list of all elections, their statuses and nominees (if requested), or an empty list if none exist",
...
async def create_election(
    ...
    if await elections.crud.get_election(db_session, slugified_name) is not None:
